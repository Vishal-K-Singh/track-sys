...
public class MainActivity extends AppCompatActivity implements LocationServiceInterface , MapInterface, ILogger{
     ...
     * Map Work Starts
     */
    private MarkerViewOptions mMarker;
    ...
    class RefreshTask extends AsyncTask {
        ...
        protected void onProgressUpdate(Object... values) {
            ...
            if (m_isLogging) {
                ...
                // message="trythis";
                try {
                    m_presenter.updateCamera(new LatLng(m_geoHashRTFilter.displayPoint.Latitude,
                            m_geoHashRTFilter.displayPoint.Longitude));
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//        btnCalibrate.setEnabled(!isLogging);
    ...
    @Override
    public void animateCamera(CameraPosition position) {
        m_map.animateCamera(CameraUpdateFactory.newCameraPosition(position), 100);
    }
    ...
    private void mapWorkTempFun() {
       /* mMarker=
                new MarkerViewOptions()
                        .position(new LatLng(48.85819, 2.29458))
                        .title("Eiffel Tower");
        m_map.addMarker(mMarker);
        m_presenter.updateCamera(new LatLng(48.85819, 2.29458));
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                mMarker.getMarker().setPosition(new LatLng(28.7041, 77.1025));
                m_presenter.updateCamera(new LatLng(28.7041, 77.1025));
            }
        },3000);*/
    }
